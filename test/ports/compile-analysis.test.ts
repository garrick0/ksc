...
import { compileAnalysis, code, withDeps } from '../../analysis/index.js';
...
function grammarWithKinds(allKinds: Set<string>, rootKind = 'Alpha'): Grammar {
  return { ...minGrammar, allKinds, rootKind };
}
...
describe('compileAnalysis — exhaustive switch generation', () => {
  ...
  it('generates KindCtx casts for per-kind syn equations', () => {
    ...
    expect(content).toContain("import type { Ctx, KindCtx } from");
