...
import { createEvaluator, validateDispatch } from '@kindscript/core-evaluator';
import type { DispatchConfig, EvaluatorConfig } from '@kindscript/core-evaluator';
import type { FieldDef, Grammar } from '@kindscript/core-grammar';
...
describe('evaluator — structural queries', () => {
  ...
  it('findFileName walks to fileContainerKind node', () => {
    const rootWithFile = {
      kind: 'Root',
      fileName: 'test.ts',
