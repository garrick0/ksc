 ...
 *
 * This is an ast-schema concern: it knows about KS node structure
 * and produces a simple, serializable representation for visualization.
 */

import type { KSTree } from './generated/convert.js';
import type { KSNode, KSCompilationUnit, KSIdentifier } from './generated/node-types.js';
import { getChildFields, fieldDefs, sumTypeMembership } from './generated/schema.js';
 ...
 */
export function extractASTData(ksTree: KSTree): ASTDashboardData {
