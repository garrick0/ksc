...
export const SAMPLE_DATA: ASTDashboardData = {
  ...
  schema: {
    fieldDefs: {
      ...
      'ImportClause': [
        { name: 'isTypeOnly', tag: 'prop', propType: 'boolean' },
      ...
      'VariableDeclarationList': [
        ...
        { name: 'declarationKind', tag: 'prop', propType: 'string' },
      ],
      'VariableDeclaration': [
      ...
      'Block': [
        ...
        { name: 'localCount', tag: 'prop', propType: 'number' },
      ],
      'ExpressionStatement': [
      ...
      'Identifier': [
        { name: 'escapedText', tag: 'prop', propType: 'string' },
        { name: 'resolvesToImport', tag: 'prop', propType: 'boolean' },
        { name: 'isDefinitionSite', tag: 'prop', propType: 'boolean' },
        { name: 'resolvedFileName', tag: 'prop', propType: 'string' },
        { name: 'symIsVariable', tag: 'prop', propType: 'boolean' },
        { name: 'symIsFunctionScopedVariable', tag: 'prop', propType: 'boolean' },
        { name: 'symIsBlockScopedVariable', tag: 'prop', propType: 'boolean' },
        { name: 'symIsFunction', tag: 'prop', propType: 'boolean' },
        { name: 'symIsClass', tag: 'prop', propType: 'boolean' },
        { name: 'symIsInterface', tag: 'prop', propType: 'boolean' },
        { name: 'symIsTypeAlias', tag: 'prop', propType: 'boolean' },
        { name: 'symIsAlias', tag: 'prop', propType: 'boolean' },
        { name: 'symIsProperty', tag: 'prop', propType: 'boolean' },
        { name: 'symIsMethod', tag: 'prop', propType: 'boolean' },
        { name: 'symIsEnum', tag: 'prop', propType: 'boolean' },
        { name: 'symIsEnumMember', tag: 'prop', propType: 'boolean' },
        { name: 'symIsNamespace', tag: 'prop', propType: 'boolean' },
        { name: 'symIsExportValue', tag: 'prop', propType: 'boolean' },
        { name: 'symIsType', tag: 'prop', propType: 'boolean' },
        { name: 'symIsValue', tag: 'prop', propType: 'boolean' },
        { name: 'importModuleSpecifier', tag: 'prop', propType: 'string' },
        { name: 'typeString', tag: 'prop', propType: 'string' },
      ],
    },
    sumTypes: {
