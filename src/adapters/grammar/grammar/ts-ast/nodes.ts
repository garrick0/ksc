 ...
 *
 * Run `ksc codegen` for analysis codegen.
 */

import type { NodeDefShape, SumTypeDefShape } from '@kindscript/core-grammar';
...
export const NODES = {
  ...
  CallExpression: {
    memberOf: ['Expression', 'UnaryExpression', 'UpdateExpression', 'LeftHandSideExpression', 'SideEffectExpression'],
    fields: {
  ...
  AwaitExpression: {
    memberOf: ['Expression', 'UnaryExpression', 'SideEffectExpression'],
    fields: {
  ...
  YieldExpression: {
    memberOf: ['Expression', 'SideEffectExpression'],
    fields: {
      expression: { tag: 'optChild', typeRef: 'Expression' } as const,
      asteriskToken: { tag: 'optChild', typeRef: 'AsteriskToken' } as const,
    },
  ...
  EqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  PlusEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  MinusEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  AsteriskEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  AsteriskAsteriskEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  SlashEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  PercentEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  LessThanLessThanEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  GreaterThanGreaterThanEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  GreaterThanGreaterThanGreaterThanEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  AmpersandEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  BarEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  BarBarEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  AmpersandAmpersandEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  QuestionQuestionEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
  CaretEqualsToken: { memberOf: ['Token', 'AssignmentOperator'], fields: {} },
