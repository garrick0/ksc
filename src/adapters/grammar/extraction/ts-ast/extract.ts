...
import { serializeNode } from '@kindscript/core-grammar';
import type { ASTNode } from '@kindscript/core-grammar';
import { grammar } from '../../grammar/ts-ast/index.js';
import type { KSTree } from '../../ast-translator/ts-ast/convert.js';
import type { KSNode, KSIdentifier } from '../../grammar/ts-ast/index.js';
