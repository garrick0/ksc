...
/** Parse-only pipeline — converts TS AST to KS AST without binder/checker. */
...
/**
 * @deprecated Use `Diagnostic` instead. Will be removed in a future version.
 */
export type { Diagnostic as CheckerDiagnostic } from '../specs/ts-ast/kind-checking/types.js';
...
export type { ASTDashboardData, ASTNode } from '../grammar/export.js';
