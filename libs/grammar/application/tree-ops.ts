 ...
 * no imports from adapters/. Reusable for any grammar (TS AST, mock, future).
 */

import type { ASTNode, FieldDef } from '../domain/ports.js';
import type { KSCommentRange } from '../domain/base-types.js';
