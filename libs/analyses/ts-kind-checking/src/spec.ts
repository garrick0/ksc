 ...
 *
 * Attribute layout:
 *   definitions            — syn: canonical root output of all kind definitions
 *   diagnostics            — syn: canonical root output of all diagnostics
...
import { code, pivotToAttrCentric } from '@ksc/behavior';
import type { TSNodeKind } from '@ksc/language-ts-ast/grammar/nodes.js';
import type { ProtobufBinding } from './equations/protobuf.js';
import {
  eq_kindDefs_default,
  eq_definitions_Program,
  eq_definitions_default,
  eq_diagnostics_Program,
  eq_diagnostics_default,
  eq_defEnv_root,
  eq_defLookup,
...
const allAttrs: AttrDecl<TSKind>[] = [
  {
    ...
    direction: 'syn',
    type: 'KindDefinition[]',
    default: eq_definitions_default,
    equations: { Program: eq_definitions_Program },
  },
  {
    name: 'diagnostics',
    direction: 'syn',
    type: 'Diagnostic[]',
    default: eq_diagnostics_default,
    equations: { Program: eq_diagnostics_Program },
  },
  // ── Structural attrs ──
  {
    name: 'kindDefs',
