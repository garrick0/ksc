...
import { compileAnalysis, validateSpec } from '../index.js';
import type { CodegenTarget, GeneratedFile, CompiledAttrDef, ValidationDiagnostic } from '../index.js';
import type { AttributeDepGraph } from '../index.js';
