 ...
 *   - AstTranslatorPort<I, R, O> — source-language → KS AST converter contract
 */
...
// ═══════════════════════════════════════════════════════════════════════
// AstTranslatorPort — source-language converter contract
// ═══════════════════════════════════════════════════════════════════════
 ...
 *
 * @example
 *   // Adapter: adapters/grammar/ast-translator/ts-ast/convert.ts
