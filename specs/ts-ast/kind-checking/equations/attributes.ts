 ...
 *
 * Also exports the `projectDefinitions` projection function.
 */
...
import type { Ctx, KindCtx } from '../../../../analysis/index.js';
import { withDeps } from '../../../../analysis/index.js';
...
export const eq_kindDefs_CompilationUnit = withDeps([],
  function eq_kindDefs_CompilationUnit(ctx: KindCtx<KSCompilationUnit>): KindDefinition[] {
    ...
    for (const childCtx of ctx.children) {
      ...
      const def = tryExtractKindDef(childCtx.node as KSTypeAliasDeclaration, getCounter());
