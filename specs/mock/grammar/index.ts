...
import type { ASTNode, KSNodeBase, ChildFieldDef, PropFieldDef, FieldDef, Grammar, GrammarMetadata, SumTypeDefShape } from '../../../grammar/index.js';
import {
...
export type { ASTNode, KSNodeBase, ChildFieldDef, PropFieldDef, FieldDef, Grammar, GrammarMetadata } from '../../../grammar/index.js';
...
export const grammar: Grammar<MockKind> = {
  ...
  rootKind: 'MockProgram' as MockKind,
